...
export default function InteriorDesignerSignup() {
  ...
  const handleVerify = () => {
    if (licenseId === "LIC12345") {
      setDesignerName("Ar. John Doe ✅");
    } else {
      setDesignerName("❌ Invalid License ID");
    }
  };
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center py-6">
      ...
      <div
        ...
        onClick={(e) => e.stopPropagation()} // 👈 prevent reset inside card
      >
        {/* Logo in top-left corner */}
        <div className="absolute top-4 left-4 z-20">
          <img
            src="/dreamdwell logo.png" // 👈 use your uploaded logo file
            alt="Logo"
          ...
          <div className="w-3/5 flex items-start justify-center pt-4 px-6">
            <div className="w-full max-w-md">
              <h2 className="text-2xl font-bold text-center mb-2 text-white drop-shadow-lg">
                {activeTab === "signup"
                  ? "Create InteriorDesigner Account"
                  : "Welcome InteriorDesigner"}
              </h2>
              {activeTab === "signup" && (
              ...
              <form className="space-y-3" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full py-2 rounded-full bg-gradient-to-r from-slate-600 to-blue-700 hover:from blue hover:to-green-600 text-white font-semibold shadow-md hover:shadow-xl transform transition-all duration-300 hover:scale-105 text-sm"
                >
